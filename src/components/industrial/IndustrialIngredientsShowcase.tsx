...
const SECTOR_APPLICATIONS_EN: SectorApplication[] = [
  {
    id: 'dairy-cheese',
...
const SECTOR_APPLICATIONS_AR: SectorApplication[] = [
  {
    id: 'dairy-cheese',
    name: 'حلول منتجات الألبان والأجبان',
    iconEmoji: '🧀',
    category: 'AWA Food Solutions & Additives',
    title: 'أنظمة مثبتات الألبان، الجبن المطبوخ ومثبتات الآيس كريم',
    description:
      'أنظمة مثبتات هيدروكولويد متطورة وأملاح استحلاب مخصصة لرفع كفاءة الإنتاج، وتحسين قابلية الانصهار والتقطيع، وضمان استقرار القوام وفترة الصلاحية.',
    solutions: [
      'مثبتات وأملاح استحلاب الجبن المطبوخ (المثلثات والبلوكات)',
      'مثبتات قوام الجبن الأبيض والفيتا الطرية',
      'مثبتات ومضادات تكتل جبن الموتزاريلا وشبيه الموتزاريلا',
      'بروتينات نباتية ولبنية لقوام ومصفوفة الأجبان',
      'نشويات معدلة وبكتين وبدائل دسم للزبادي واللبن الرائب',
      'مثبتات ومستحلبات وبدائل حليب للآيس كريم والمثلجات',
      'مثبتات ومواد حفظ لكريمة الخفق وكريمة الطهي',
      'منفحة طبيعية، حمض اللاكتيك، وشمع تغليف وتشميع الجبن',
    ],
    image: '/images/pages/solutions/dairy.jpg',
    specSummary: 'مؤشرات انصهار مخصصة، قدرة ربط ماء حتى 65%، منع تام لانفصال مصل اللبن (Syneresis).',
  },
  {
    id: 'bakery-pastry',
    name: 'المخبوزات والبسكويت والحلويات',
    iconEmoji: '🥖',
    category: 'AWA Food Solutions',
    title: 'محسنات الدقيق الإنزيمية، المستحلبات وخلطات الكيك الصناعية',
    description:
      'حلول متكاملة للمخابز ومصانع البسكويت تضمن مرونة العجين وسهولة تشغيله آلياً، وزيادة حجم الرغيف، ونعومة اللبابة، وتأخير البيات لإطالة فترة الطزاجة.',
    solutions: [
      'خلطات الكيك والمفن الجاهزة للاستخدام الصناعي',
      'مستحلبات المخبوزات (DATEM و SSL وأحادي وثنائي الجليسريد)',
      'محسنات دقيق إنزيمية وجلوتين قمح حيوي فائق النقاوة',
      'نشويات معدلة لقوام المخبوزات ودقيق صويا منزوع الدسم',
      'محليات دايت وأنظمة سوربيتول للمخبوزات الخالية من السكر',
      'مستخلصات فانيليا طبيعية وبودرة كاكاو هولندي فاخرة',
      'عوامل رفع كيميائية ومساحيق بيكنج بودر مزدوجة التأثير',
      'بدائل بيض اقتصادية وأنظمة مضادات عفن لإطالة الصلاحية',
    ],
    image: '/images/pages/solutions/bakery.jpg',
    specSummary: 'طراوة تدوم حتى 30 يوماً بدرجة حرارة الغرفة، مرونة عجين متجانسة، وفر كبير في تكلفة البيض.',
  },
  {
    id: 'meat-poultry',
    name: 'تصنيع اللحوم والدواجن والمصنعات',
    iconEmoji: '🥩',
    category: 'AWA Food Solutions & AWASOY',
    title: 'بروتينات وظيفية، محسنات قوام وخلطات فوسفات غذائي',
    description:
      'مصفوفات مكونات وظيفية متطورة لإنتاج اللانشون، السجق، البرجر، الكفتة، الفرانكفورتر، ومصنعات الدواجن المعاد تشكيلها بأعلى نسب تصافي وجودة.',
    solutions: [
      'بروتين صويا نباتي محكم البنية وظيفي (Soy TVP)',
      'بروتين صويا معزول نقي (ISP 90%) ومركزات بروتين الصويا',
      'أملاح فوسفات غذائية صوديوم وبوتاسيوم معتمدة',
      'ألياف غذائية نباتية وكولاجين متحلل لربط السوائل',
      'نشويات بطاطس وذرة معدلة عالية القدرة على حبس الماء',
      'محسنات قوام وتماسك عجينة البرجر والمفروم',
      'محسنات تقطيع فائقة الأداء للحوم الباردة والمصنعات',
      'ألوان طبيعية، مواد حفظ معتمدة، وأنظمة مضادات أكسدة',
    ],
    image: '/images/pages/solutions/meat.jpg',
    specSummary: 'نسبة استحلاب 1:5:5 (بروتين:ماء:دهن)، تماسك مثالي عند التقطيع، ثبات تام بالتجميد والفك.',
  },
  {
    id: 'sauces-condiments',
    name: 'الصلصات، الدريسنج والكاتشب',
    iconEmoji: '🍅',
    category: 'AWA Food Solutions',
    title: 'مثبتات هيدروكولويد، بدائل بيض ومعدلات اللزوجة',
    description:
      'أنظمة تثبيت فائقة المقاومة للقص الميكانيكي والحموضة والحرارة لإنتاج المايونيز، والكاتشب، وتتبيلات السلطات، والصلصات التغميس، وقواعد الشوربة سريعة التحضير.',
    solutions: [
      'بدائل ومضاعفات معجون الطماطم عالية التركيز',
      'بدائل بيض كاملة للمايونيز النباتي والمايونيز الدايت',
      'نشويات ذرة شمعية معدلة عالية اللزوجة ومقاومة للحرارة',
      'خلطات هيدروكولويد صمغ الزانثان والجوار سريعة الانتفاخ على البارد',
      'مساحيق دهون ميكروية مغلّفة وكريمة بودرة',
      'خلطات حفظ معتمدة (بنزوات الصوديوم / سوربات البوتاسيوم)',
      'أحماض غذائية (حمض الستريك، اللاكتيك، الخليك، والماليك)',
      'ملونات طبيعية وراتنجات زيتية عطرية مقاومة للحرارة',
    ],
    image: '/images/pages/solutions/sauces.jpg',
    specSummary: 'لزوجة ثيكسوتروبية قابلة للاستعادة، انعدام تام لانفصال الزيت عند درجة حموضة pH 3.2، تشغيل على البارد.',
  },
  {
    id: 'beverages-juices',
    name: 'المشروبات والعصائر والمياه الغازية',
    iconEmoji: '🥤',
    category: 'AWA Food Solutions & Bio Ingredients',
    title: 'عوامل تعكير، مثبتات ألياف ومستحلبات نكهة',
    description:
      'أنظمة مكونات جاهزة ومصممة لإنتاج نكتار الفواكه، والمشروبات الغازية، ومشروبات الطاقة والشعير، والمساحيق سريعة الذوبان المجففة بالرش.',
    solutions: [
      'عوامل تعكير طبيعية ومثبتات تعليق لب الفواكه بالعصائر',
      'قواعد بودرة مشروبات وعصائر فورية متكاملة التركيب',
      'محليات صناعية وطبيعية عالية التحلية (سكرالوز، ستيفيا، أسيسولفام)',
      'مستحلبات زيوت عطرية طبيعية (برتقال، ليمون، يوسفي)',
      'معدلات حموضة (حمض ستريك، سترات صوديوم، حمض ماليك)',
      'ألوان طعام طبيعية قابلة للذوبان بالماء (كاروتينويدات، أنثوسيانين)',
      'بروتينات نباتية ذائبة وفيتامينات تدعيم وظيفية',
      'أنظمة حفظ سائلة متوافقة مع المواصفات القياسية',
    ],
    image: '/images/pages/solutions/beverages.jpg',
    specSummary: 'ذوبان نقي بلوري، انعدام الترسيب بالقاع، ثبات تام تحت أشعة الشمس والبسترة الحرارية.',
  },
  {
    id: 'confectionery-chocolates',
    name: 'الحلويات، الشوكولاتة والسكاكر',
    iconEmoji: '🍬',
    category: 'AWA Food Solutions',
    title: 'عوامل هلامية، مواد تلميع، كاكاو ودهون تخصصية',
    description:
      'مكونات عالية الأداء للمصاصات والحلوى الصلبة، والجيلي كاندي، والتوفي، وبدائل الشوكولاتة، وشوكولاتة السبريد، وحشوات المخبوزات والكرواسون.',
    solutions: [
      'عوامل ترويق ونقاء للحلوى الصلبة والسكاكر الشفافة',
      'مواد تلميع شمع الكرنوبا والشيلاتين لإكساب الجيلي بريقاً فائقاً',
      'مساعدات تشغيل مانعة للالتصاق لقوالب صب الجيلي كاندي',
      'مساحيق كاكاو فاخرة (طبيعي ومُقلوَن هولندي)',
      'معجون بندق محمص طبيعي نقي 100% للشوكولاتة والسبريد',
      'قواعد علك مخصصة للبان والفقاعات',
      'بكتين وبدائل سكر للمربيات وحشوات الفواكه الصناعية',
      'مستحلبات ليسيثين الصويا ودوار الشمس عالية النقاوة',
    ],
    image: '/images/pages/solutions/confectionery.jpg',
    specSummary: 'منع تحول دهون الشوكولاتة (Fat Bloom)، درجة انتقال زجاجي عالية (Tg)، قرمشة وملمس مثالي.',
  },
];
...
const BIO_INGREDIENTS_DATA_EN: BioIngredientCategory[] = [
  {
...
const BIO_INGREDIENTS_DATA_AR: BioIngredientCategory[] = [
  {
    title: 'الراتنجات الزيتية الطبيعية (Oleoresins)',
    badge: 'مستخلصات بيولوجية مركزة',
    description:
      'مستخلصات سائلة نقية فائقة التركيز تحتوي على الزيوت العطرية المتطايرة والمكونات الحارة الفعالة، تمنح إطلاقاً فورياً للنكهة وتجانساً دقيقاً في كل دفعة إنتاج.',
    items: [
      'فلفل أسود',
      'فلفل حار (كابسيسين)',
      'بابريكا (لون ونكهة)',
  ...
  {
    title: 'الزيوت العطرية الأساسية (Essential Oils)',
    badge: 'تقطير بالبخار 100%',
    description:
      'مركبات عطرية متطايرة نقية 100% مستخلصة بالتقطير بالبخار أو التقطير المائي لإكساب المأكولات والمشروبات والتتبيلات النوتات العطرية الأولية الأصيلة.',
    items: [
      'زيت الفلفل الأسود',
      'زيت الفلفل الأبيض',
      'زيت الزنجبيل',
  ...
  {
    title: 'خلطات التوابل السائلة ومستخلصات Hydrops™',
    badge: 'تركيبات جاهزة للحقن والخلط',
    description:
      'تتبيلات سائلة مخصصة لمصنعات اللحوم والصلصات والشعرية سريعة التحضير. تقنية Spice Hydrops™ تضمن ذوباناً وتشتتاً تاماً في السوائل المائية.',
    items: [
      'خلطة توابل السجق الشرقي',
      'خلطة السجق الإسكندراني',
      'تتبيلة برجر اللحم البقري',
      'تتبيلة الكفتة والكباب السائلة',
      'تتبيلة سائلة لنكهة البسطرمة',
      'خلطة السجق التركي (السجق التركي)',
      'تتبيلة التندوري السائلة',
      'تتبيلة صلصات البيتزا والباستا',
      'خلطة مرقة النودلز سريعة التحضير',
      'مستخلصات التوابل الذائبة بالماء Hydrops™',
    ],
    icon: <FlaskConical size={22} style={{ color: '#D97706' }} />,
  },
];
...
export const IndustrialIngredientsShowcase: React.FC<IndustrialIngredientsShowcaseProps> = ({
  ...
  const sectorApplications = language === 'ar' ? SECTOR_APPLICATIONS_AR : SECTOR_APPLICATIONS_EN;
  const bioIngredientsData = language === 'ar' ? BIO_INGREDIENTS_DATA_AR : BIO_INGREDIENTS_DATA_EN;

  const [activeSectorIndex, setActiveSectorIndex] = useState<number>(0);
  const [selectedDivision, setSelectedDivision] = useState<string>('all');

  const activeSector = sectorApplications[activeSectorIndex] || sectorApplications[0];

  const divisions = [
    {
      id: 'additives',
      name: language === 'ar' ? 'شركة AWA لمضافات الأغذية' : 'AWA Food Additives Co.',
      badge: language === 'ar' ? 'تأسست 1993' : 'Est. 1993',
      tagline: language === 'ar' ? 'جودة عالية، صحية ومبتكرة' : 'High Quality, Healthy & Innovative',
      desc: language === 'ar'
        ? 'الذراع التجاري والتوزيعي للمواد الخام المعتمدة، المواد الحافظة، الأحماض الغذائية، الفوسفات والمستحلبات مع إدارة متكاملة لسلاسل الإمداد.'
        : 'Core trading and distribution of raw additives, preservatives, acidulates, phosphates, and emulsifiers with lean supply chain integration.',
    },
    {
      id: 'solutions',
      name: language === 'ar' ? 'AWA Food Solutions (حلول الأغذية)' : 'AWA Food Solutions',
      badge: language === 'ar' ? 'هندسة وظيفية مخصصة' : 'Custom Engineering',
      tagline: language === 'ar' ? 'نبتكر حلولاً مصممة لخطوط إنتاجكم' : 'Developing Tailored Solutions',
      desc: language === 'ar'
        ? 'أنظمة مثبتات هيدروكولويد مخصصة ومحسنات قوام مصممة هندسياً لمصانع الألبان واللحوم والمخبوزات والعصائر.'
        : 'Tailored functional stabilizer systems, hydrocolloid matrices, and texture improvers optimized for dairy, meat, bakery, and beverage plants.',
    },
    {
      id: 'bio',
      name: language === 'ar' ? 'AWA Bio Ingredients (المستخلصات الحيوية)' : 'AWA Bio Ingredients',
      badge: language === 'ar' ? 'استخلاص طبيعي نقي' : 'Natural Extraction',
      tagline: language === 'ar' ? 'معالجة طبيعية بأعلى معايير الدقة' : 'Processed to Perfection',
      desc: language === 'ar'
        ? 'راتنجات زيتية نقية للتوابل، زيوت عطرية مقطرة بالبخار، ألوان طعام طبيعية موحدة القياس الطيفي، ومستخلصات Hydrops™ الذائبة بالماء.'
        : 'Pure spice oleoresins, steam-distilled essential oils, spectrophotometer-standardized natural colors, and Spice Hydrops™.',
    },
    {
      id: 'awabey',
      name: 'AWABEY',
      badge: language === 'ar' ? 'مشروع مشترك تركي-مصري' : 'Joint Venture',
      tagline: language === 'ar' ? 'تكنولوجيا مستخلص عرق الحلاوة' : 'Soapwort Extract Technology',
      desc: language === 'ar'
        ? 'مصنع متخصص بطاقة 7 طن/يوم لإنتاج مستخلص عرق الحلاوة النقي (Çöven Suyu) بدرجات تركيز من 3° إلى 45° بريكس لصناعة الحلاوة الطحينية والحلويات.'
        : 'Egyptian-Turkish specialized facility producing 7 MT/day of high-brix soapwort extract (Çöven Suyu) for the halva and confectionery industry.',
    },
    {
      id: 'awasoy',
      name: 'AWASOY',
      badge: language === 'ar' ? 'بروتينات نباتية' : 'Plant Protein',
      tagline: language === 'ar' ? 'أنظمة الصويا الوظيفية' : 'Functional Soy Systems',
      desc: language === 'ar'
        ? 'بروتين الصويا وظيفي البنية (Soy TVP)، بروتين صويا معزول نقي (ISP 90%) ومركزات صويا لمصنعات اللحوم لرفع كفاءة ومردود التصنيع.'
        : 'Textured vegetable protein (Soy TVP), isolated soy protein (ISP 90%), and functional concentrates for high-yield meat processing.',
    },
  ];
      ...
      <section className="ind-hero-section">
        <div className="ind-hero-container">
          <div className="ind-hero-eyebrow">
            <Factory size={16} />
            <span>{language === 'ar' ? 'مجموعة AWA • حلول ومكونات الصناعات الغذائية منذ 1993' : 'AWA Group • Food Solutions & Ingredients Since 1993'}</span>
          </div>

          <h1 className="ind-hero-title">
            {language === 'ar'
              ? 'مكونات الأغذية الصناعية وأنظمة التركيبات الوظيفية المخصصة'
              : 'INDUSTRIAL INGREDIENTS & TAILORED FORMULATION SYSTEMS'}
          </h1>

          <p className="ind-hero-desc">
            {language === 'ar'
              ? 'شريك موثوق لأكثر من 2,000 مصنع أغذية في مصر والشرق الأوسط وأفريقيا. نقوم بتصنيع وخلط وتوزيع أكثر من 200 مضاف غذائي متخصص، ومثبتات هيدروكولويد، ومستخلصات طبيعية من مجمع مصانعنا بمدينة برج العرب الجديدة.'
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            >
              <FileText size={18} />
              <span>{language === 'ar' ? 'طلب النشرات والمواصفات الفنية (TDS / COA)' : 'Request Technical Spec Sheet (TDS/COA)'}</span>
              <ArrowRight size={16} />
            </button>
            <a
            ...
            >
              <Layers size={18} />
              <span>{language === 'ar' ? 'استعراض القطاعات الصناعية' : 'Explore Application Sectors'}</span>
            </a>
          </div>
          ...
          <div className="ind-stats-row">
            <div className="ind-stat-card">
              ...
              <div className="ind-stat-label">{language === 'ar' ? 'عاماً من الخبرة' : 'Years Heritage'}</div>
              <div className="ind-stat-sub">{language === 'ar' ? 'تأسست عام 1993' : 'Founded in 1993'}</div>
            </div>

            <div className="ind-stat-card">
              <div className="ind-stat-number">+200</div>
              <div className="ind-stat-label">{language === 'ar' ? 'مضافاً ومثبتاً غذائياً' : 'Food Additives'}</div>
              <div className="ind-stat-sub">{language === 'ar' ? 'خلطات مخصصة' : 'Custom Blends'}</div>
            </div>

            <div className="ind-stat-card">
              <div className="ind-stat-number">+2,000</div>
              <div className="ind-stat-label">{language === 'ar' ? 'عميل صناعي B2B' : 'B2B Clients'}</div>
              <div className="ind-stat-sub">{language === 'ar' ? 'مصانع أغذية كبرى' : 'Industrial Plants'}</div>
            </div>

            <div className="ind-stat-card">
              <div className="ind-stat-number">15.5 طن</div>
              <div className="ind-stat-label">{language === 'ar' ? 'طاقة إنتاجية / ساعة' : 'Hourly Capacity'}</div>
              <div className="ind-stat-sub">{language === 'ar' ? '3 خطوط مساحيق + سوائل' : '3 Powder + Liquid'}</div>
            </div>

            <div className="ind-stat-card">
              <div className="ind-stat-number">15,000 طن</div>
              <div className="ind-stat-label">{language === 'ar' ? 'سعة التخزين المستودعي' : 'Warehouse Size'}</div>
              <div className="ind-stat-sub">{language === 'ar' ? 'مساحة 3,700 م²' : '3,700 m² Facility'}</div>
            </div>

            <div className="ind-stat-card">
              <div className="ind-stat-number">5x</div>
              <div className="ind-stat-label">{language === 'ar' ? 'شهادات جودة دولية' : 'Global Certs'}</div>
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto 1.75rem auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <div style={{ fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', color: '#0284C7', marginBottom: '0.25rem' }}>
              {language === 'ar' ? 'الهيكل المؤسسي للمجموعة' : 'Corporate Structure'}
            </div>
            <h3 style={{ fontSize: '1.5rem', fontWeight: 900, color: '#0F172A' }}>
              {language === 'ar' ? 'قطاعات وشركات مجموعة AWA الصناعية' : 'AWA GROUP OPERATING DIVISIONS'}
            </h3>
          </div>
          <p style={{ fontSize: '0.875rem', color: '#64748B', maxWidth: '520px', margin: 0 }}>
            {language === 'ar'
              ? 'وحدات أعمال تصنيعية متخصصة تشمل الإضافات الكيميائية النقية، والخلطات الوظيفية، والمستخلصات الطبيعية، وتكنولوجيا عرق الحلاوة.'
      ...
      <section id="sectors-section" className="ind-sectors-section">
        <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 2.5rem auto' }}>
          <div className="fmcg-eyebrow" style={{ borderColor: '#0284C7', color: '#0284C7' }}>
            <Boxes size={15} />
            <span>{language === 'ar' ? 'مصفوفة حلول القطاعات الصناعية الغذائية' : 'Industrial Sector Solutions Matrix'}</span>
          </div>
          <h2 style={{ fontSize: 'clamp(2.2rem, 4vw, 3.25rem)', fontWeight: 900, textTransform: 'uppercase', color: '#0F172A', letterSpacing: '-0.02em', marginBottom: '0.5rem' }}>
            {language === 'ar' ? 'علوم وتكنولوجيا الأغذية التطبيقية' : 'APPLICATION-DRIVEN FOOD SCIENCE'}
          </h2>
          <p style={{ fontSize: '1rem', color: '#475569', lineHeight: 1.6 }}>
            {language === 'ar'
              ? 'اختر قطاعك الصناعي أدناه لاستعراض أنظمة المثبتات المخصصة، والمضافات الوظيفية، ومواصفات الأداء الفني.'
        ...
        <div className="ind-sector-tabs-row">
          {sectorApplications.map((sector, idx) => {
            ...
            <div>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <div style={{ fontSize: '0.8rem', fontWeight: 800, textTransform: 'uppercase', color: '#0F172A', marginBottom: '0.75rem', letterSpacing: '0.04em' }}>
                  {language === 'ar' ? 'التركيبات والمنتجات المتاحة في هذا القطاع:' : 'Available Formulations & Products in this Sector:'}
                </div>
              ...
              <div style={{ padding: '1rem 1.25rem', borderRadius: '16px', background: '#F0F9FF', border: '1px solid rgba(2, 132, 199, 0.2)', marginBottom: '2rem' }}>
                <div style={{ fontSize: '0.75rem', fontWeight: 800, color: '#0369A1', textTransform: 'uppercase', marginBottom: '0.2rem' }}>
                  {language === 'ar' ? 'المواصفات الفنية المستهدفة:' : 'Technical Target Specs:'}
                </div>
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                ...
                >
                  <Send size={16} />
                  <span>
                    {language === 'ar' ? `طلب عينات تجارب ومواصفات ${activeSector.name}` : `Request ${activeSector.name} Sample / COA`}
                  </span>
                </button>
              </div>
            </div>
            ...
            <div className="ind-sector-img-box">
              ...
              <div style={{ position: 'absolute', bottom: '1.25rem', left: '1.25rem', right: '1.25rem', padding: '1rem', borderRadius: '16px', background: 'rgba(15, 23, 42, 0.85)', backdropFilter: 'blur(16px)', color: '#FFFFFF' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', color: '#38BDF8' }}>
                  ...
                  <span>{language === 'ar' ? 'معتمد ومختبر معملياً في وحدات التطبيق' : 'Pilot Plant Validated'}</span>
                </div>
                <div style={{ fontSize: '0.8rem', color: '#E2E8F0', marginTop: '2px' }}>
                  {language === 'ar'
                    ? 'تركيبات مختبرة تحت درجات حرارة البسترة العالية وقوى القص الميكانيكي الصناعي.'
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 3rem auto' }}>
            <div className="fmcg-eyebrow" style={{ borderColor: '#059669', color: '#059669' }}>
              <Leaf size={15} />
              <span>{language === 'ar' ? 'قطاع المستخلصات الحيوية AWA Bio Ingredients' : 'AWA Bio Ingredients Division'}</span>
            </div>
            <h2 style={{ fontSize: 'clamp(2rem, 3.5vw, 2.75rem)', fontWeight: 900, color: '#0F172A', textTransform: 'uppercase', letterSpacing: '-0.02em', marginBottom: '0.5rem' }}>
              {language === 'ar' ? 'مستخلصات التوابل الطبيعية والراتنجات الزيتية' : 'NATURAL SPICE EXTRACTS & OLEORESINS'}
            </h2>
            <p style={{ fontSize: '0.95rem', color: '#475569', lineHeight: 1.6 }}>
              {language === 'ar'
                ? 'عندما تحتفظ الطبيعة بنكهات لا تضاهى — نستخلص خلاصات التوابل والأعشاب النقية بأحدث تقنيات الاستخلاص للحفاظ على الرائحة العطرية القوية، والحرارة الفعالة، والتعقيم الميكروبيولوجي الكامل.'
          ...
          <div className="ind-bio-grid">
            {bioIngredientsData.map((bio, idx) => (
              <div key={idx} className="ind-bio-card">
                <div>
                  ...
                  <div style={{ fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', color: '#0F172A', marginBottom: '0.5rem' }}>
                    {language === 'ar' ? 'قائمة المنتجات القياسية:' : 'Standard Product Range:'}
                  </div>
                ...
                >
                  <span>{language === 'ar' ? 'طلب كتالوج المستخلصات الحيوية' : 'Request Bio Ingredients Catalog'}</span>
                  <ArrowRight size={14} />
                </button>
              </div>
            ))}
        ...
        <div className="ind-soapwort-grid">
          <div className="ind-soapwort-card">
            <div className="fmcg-eyebrow" style={{ borderColor: '#D97706', color: '#D97706', marginBottom: '0.75rem' }}>
              <Award size={15} />
              <span>{language === 'ar' ? 'مشروع AWABEY المشترك' : 'AWABEY Joint Venture'}</span>
            </div>
            <h2 style={{ fontSize: '2.35rem', fontWeight: 900, color: '#0F172A', lineHeight: 1.15, marginBottom: '0.75rem' }}>
              {language === 'ar' ? 'ريادة تكنولوجيا مستخلص عرق الحلاوة' : 'PIONEERING SOAPWORT EXTRACT TECHNOLOGY'}
            </h2>
            <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#D97706', marginBottom: '1.25rem' }}>
              {language === 'ar'
                ? 'مواد خام تركية طبيعية 100% • طاقة إنتاجية 7 طن / يوم'
            ...
            <p style={{ fontSize: '0.925rem', color: '#475569', lineHeight: 1.65, marginBottom: '1.5rem' }}>
              {language === 'ar'
                ? 'يعمل مصنع AWABEY بأحدث تكنولوجيا استخلاص تركية لإنتاج مستخلص عرق الحلاوة النقي (Çöven Suyu) بتركيزات مخصصة تبدأ من 3° بريكس وتصل حتى 45° بريكس، معتمداً لدى كبرى شركات الحلاوة الطحينية والحلويات في مصر والشرق الأوسط.'
                : 'AWABEY operates with cutting-edge Turkish extraction technology to produce pure Soapwort Extract (Çöven Suyu) with custom concentrations from 3° Brix to 45° Brix. Trusted by the largest halva, tahini, and confectionery producers across Egypt and international export markets.'}
            </p>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem', marginBottom: '2rem' }}>
              {(language === 'ar'
                ? [
                    'عامل رغوي ومبيّض طبيعي أساسي لصناعة الحلاوة الطحينية والمارشميلو',
                    'الخواص الحسية: سائل بني مميز، رائحة عطرية طبيعية، طعم مائل للمرارة الخفيفة',
                    'شهادة خلو تام من مسببات الحساسية متوافقة مع منظمة الصحة العالمية (WHO)',
                    'معبأ في براميل وجرادل صناعية 30 كجم مع فترة صلاحية مضمونة 24 شهراً',
                    'إشراف مباشر من مهندسي استخلاص وتصنيع أغذية أتراك',
                  ]
                : [
            ...
            >
              <ShoppingBag size={16} />
              <span>{language === 'ar' ? 'طلب عينة تجريبية 30 كجم عرق حلاوة' : 'Request Soapwort 30kg Trial Bucket'}</span>
            </button>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div style={{ background: '#FFFFFF', padding: '2rem', borderRadius: '24px', border: '1.5px solid rgba(0,0,0,0.08)', boxShadow: '0 10px 30px rgba(0,0,0,0.03)' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', color: '#64748B', marginBottom: '0.5rem' }}>
                {language === 'ar' ? 'المواصفات الفنية الرئيسية' : 'Key Technical Specifications'}
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div style={{ padding: '1rem', borderRadius: '16px', background: '#FEF3C7', border: '1px solid rgba(217, 119, 6, 0.2)' }}>
                  ...
                  <div style={{ fontSize: '0.725rem', fontWeight: 700, color: '#92400E', textTransform: 'uppercase' }}>
                    {language === 'ar' ? 'نطاق تركيز البريكس' : 'Brix Concentration Range'}
                  </div>
                </div>
                <div style={{ padding: '1rem', borderRadius: '16px', background: '#FEF3C7', border: '1px solid rgba(217, 119, 6, 0.2)' }}>
                  <div style={{ fontSize: '1.65rem', fontWeight: 900, color: '#B45309' }}>
                    {language === 'ar' ? '7 طن / يوم' : '7 MT / Day'}
                  </div>
                  <div style={{ fontSize: '0.725rem', fontWeight: 700, color: '#92400E', textTransform: 'uppercase' }}>
                    {language === 'ar' ? 'طاقة الإنتاج اليومية' : 'Production Output'}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style={{ background: '#FFFFFF', padding: '2rem', borderRadius: '24px', border: '1.5px solid rgba(0,0,0,0.08)', boxShadow: '0 10px 30px rgba(0,0,0,0.03)' }}>
              <div style={{ fontSize: '0.85rem', fontWeight: 800, color: '#0F172A', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                ...
                <span>{language === 'ar' ? 'جودة معتمدة ومفحوصة معملياً' : 'Laboratory Certified Quality'}</span>
              </div>
              <p style={{ fontSize: '0.85rem', color: '#475569', lineHeight: 1.5, margin: 0 }}>
                {language === 'ar'
                  ? 'تخضع كل تشغيلة إنتاج لفحوصات حسية وميكروبيولوجية وكثافة تركيز شاملة قبل الشحن. خالي تماماً من المواد السامة والمضافات التخليقية.'
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 2rem auto' }}>
            <div className="fmcg-eyebrow" style={{ borderColor: '#0284C7', color: '#0284C7' }}>
              ...
              <span>{language === 'ar' ? 'مركز التطبيقات المعملية وضمان الجودة' : 'R&D Application Center & Quality Assurance'}</span>
            </div>
            <h2 style={{ fontSize: 'clamp(2rem, 3.5vw, 2.75rem)', fontWeight: 900, color: '#0F172A', textTransform: 'uppercase', letterSpacing: '-0.02em', marginBottom: '0.5rem' }}>
              {language === 'ar' ? 'محاكاة خطوط الإنتاج والشهادات العالمية' : 'PILOT PLANT SIMULATION & GLOBAL CERTIFICATIONS'}
            </h2>
            <p style={{ fontSize: '0.95rem', color: '#475569', lineHeight: 1.6 }}>
              {language === 'ar'
                ? 'مركز أبحاث وتطبيقات AWA بمدينة برج العرب الجديدة مجهز بوحدات إنتاج تجريبية لاختبار التشغيلات المصغرة، وأجهزة قياس الخواص الريولوجية ومطياف القياس الضوئي لضمان تطابق الجودة في كل تشغيلة.'
          ...
          <div className="ind-certs-grid">
            {[
              { 
                code: 'FSSC 22000', 
                name: language === 'ar' ? 'نظام سلامة الغذاء العالمي' : 'Food Safety System Certification', 
                authority: 'ACERTA Middle East' 
              },
              { 
                code: 'ISO 9001:2015', 
                name: language === 'ar' ? 'نظام إدارة الجودة' : 'Quality Management Systems', 
                authority: 'IAF Accredited' 
              },
              { 
                code: 'ISO 22000:2018', 
                name: language === 'ar' ? 'إدارة سلامة الغذاء' : 'Food Safety Management', 
                authority: 'Global Benchmark' 
              },
              { 
                code: 'ISO 14001:2015', 
                name: language === 'ar' ? 'نظام الإدارة البيئية' : 'Environmental Management', 
                authority: 'Sustainable Operations' 
              },
              { 
                code: 'ISO 45001:2018', 
                name: language === 'ar' ? 'السلامة والصحة المهنية' : 'Occupational Health & Safety', 
                authority: 'Zero-Hazard Plant' 
              },
            ].map((cert, idx) => (
          ...
          <div style={{
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', color: '#0284C7', marginBottom: '0.25rem' }}>
                <Building2 size={16} />
                <span>{language === 'ar' ? 'المقر الرئيسي: الإسكندرية • فرع القاهرة • المصنع: برج العرب الجديدة' : 'Head Office: Alexandria • Cairo Branch • Factory: New Borg El-Arab'}</span>
              </div>
              <h4 style={{ fontSize: '1.5rem', fontWeight: 900, color: '#0F172A', marginBottom: '0.25rem' }}>
                {language === 'ar' ? 'هل أنت مستعد لتطوير خط إنتاجك وخفض تكاليف التصنيع؟' : 'Ready to Upgrade Your Food Manufacturing Line?'}
              </h4>
              <p style={{ fontSize: '0.875rem', color: '#475569', margin: 0 }}>
                {language === 'ar'
                  ? 'فريق المبيعات الفنية وعلماء الأغذية في مركز R&D مستعدون لمساعدتكم في تطوير الوصفات وخفض التكاليف وإرسال عينات التجارب.'
            ...
            >
              <Send size={16} />
              <span>{language === 'ar' ? 'تواصل مع فريق المبيعات الصناعية' : 'Connect with Industrial Sales'}</span>
              <ArrowRight size={16} />
            </button>
          </div>
        </div>
